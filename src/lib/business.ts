// Central business data — single source of truth for all components.
// Update values here and they flow through the whole site.
...
export const business = {
  ...
  tagline: "Mobile Car Battery Replacement on the Gold Coast",
  owner: "David",
  ownerFull: "David Sorbello",
};
...
export const reviews = [
  {
    name: "Alphonse C.",
    text: "My car wouldn't start before work and David arrived faster than expected. Battery replaced on the spot and I was back on the road within the hour.",
  },
  {
    name: "Connie S.",
    text: "Fantastic service. Friendly, professional and upfront about the pricing. Highly recommend for anyone stuck with a flat battery.",
  },
  {
    name: "Laura B.",
    text: "Called late at night and was surprised someone answered straight away. Quick response and great service.",
  },
  {
    name: "Vince C.W.",
    text: "David tested the battery, explained everything clearly and had a new one installed in no time. Great experience.",
  },
  {
    name: "Mark Anton",
    text: "Fast, reliable and reasonably priced. Saved me from needing a tow truck.",
  },
  {
    name: "Basil Costas",
    text: "Needed urgent help on a Sunday morning. Fast response and quality workmanship. Would definitely use again.",
  },
];
...
export const faqs = [
  {
    ...
    a: "We aim to reach you as quickly as possible — most jobs are completed within the hour of your call, depending on your location and the time of day.",
  },
  {
    q: "Do you really come to me?",
    a: "Yes. We're fully mobile. We come to your home, workplace, or roadside anywhere on the Gold Coast — no need to tow your car or visit a workshop.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes — we replace starter and deep-cycle batteries for boats, jet skis and dual-battery setups. Call with your vessel details and we'll give you a quote.",
  },
  {
  ...
  },
  {
    ...
    a: "We take it away and dispose of it responsibly through proper recycling — included free with every job.",
  },
  {
    q: "Do you offer a warranty?",
    a: "Yes, every battery we install comes with a warranty. We'll confirm the exact terms when we arrive.",
  },
];
